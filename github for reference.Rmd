...
mv gethub* Github/ # it will move all the files which are named to
gethub into the Github folder.
...
https://github.com/singhsachinosu/Github-and-R-Markdown.git # neeed to make a Github new repository of desired name and take copy the location and paste to above mentioned command.
